...
const ApiConfigurationMessage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-3xl bg-gray-800 rounded-xl p-8 border border-red-500/50 shadow-2xl">
        ...
        <div className="bg-gray-900/70 p-6 rounded-lg border border-gray-700 space-y-6">
          ...
          <div className="space-y-2">
             ...
             <ul className="list-disc list-inside text-gray-400 pl-2 space-y-2">
                <li>Rename <code className="text-sm text-cyan-300 bg-gray-800 px-2 py-1 rounded-md">API_KEY</code> to <code className="text-sm text-green-300 bg-gray-800 px-2 py-1 rounded-md">VITE_API_KEY</code></li>
                <li>Rename <code className="text-sm text-cyan-300 bg-gray-800 px-2 py-1 rounded-md">MAPS_API_KEY</code> to <code className="text-sm text-green-300 bg-gray-800 px-2 py-1 rounded-md">VITE_MAPS_API_KEY</code></li>
             </ul>
          </div>

          <div>
             <h3 className="font-medium text-gray-200 mb-2">Google Gemini API Key</h3>
             <code className="text-sm text-green-300 bg-gray-800 px-2 py-1 rounded-md mt-1 block">VITE_API_KEY</code>
           ...
           <div>
             ...
             <code className="text-sm text-green-300 bg-gray-800 px-2 py-1 rounded-md mt-1 block">VITE_MAPS_API_KEY</code>
